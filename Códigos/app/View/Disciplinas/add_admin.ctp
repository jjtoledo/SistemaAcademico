<div class="container-fluid">
    ...
    <li><?php echo $this->Html->link(
		...
		<?php 
			echo $this->Form->create('Disciplina', array('action' => 'add'));
			echo $this->Form->input('codigo', array('class' => 'form-control'));
			echo $this->Form->input('nome', array('class' => 'form-control'));
			echo $this->Form->input('departamento', array('class' => 'form-control'));
			echo $this->Form->input('carga_horaria', array('class' => 'form-control'));
			echo $this->Form->input('professor_id', array('class' => 'form-control'));
			echo $this->Form->input('curso_id', array('class' => 'form-control'));
			echo $this->Form->input('Cadastrar', array('type' => 'submit', 'class' => 'btn btn-success', 'label' => ''));
		?>
		</div>
	</div>
