  ...
  <div class="row">
		...
		<div class="col-md-8 col-md-offset-1">
			...
			<div class="table-responsive">
				<legend>Dados dos Professores</legend>
				<table class="table table-striped table-hover table-bordered">
					...
					<?php foreach ($professors as $s): ?>
					<tr>
						<td><?php echo $s['Professor']['id'] ?></td>
						<td><?php echo $s['Professor']['nome'] ?></td>
						<td><?php echo $s['Professor']['email'] ?></td>
