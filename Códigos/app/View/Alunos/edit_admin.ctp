...
<?php 
	...
	echo $this->Form->input('senha', array('class' => 'form-control', 'disabled', 'type' => 'password'));
	echo $this->Form->input('curso_id', array('class' => 'form-control'));
	echo $this->Form->input('disciplinas', array('multiple','class' => 'form-control', 'name' => 'Disciplina[]'));
