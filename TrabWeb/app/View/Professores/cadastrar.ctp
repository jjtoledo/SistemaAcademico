					...
					<div class="collapse navbar-collapse" id="myNavbar">
						<div class="col-md-4 col-sm-4 col-xs-12">
					  	...
					  	<div class="col-md-6 col-sm-6 col-xs-12">
						  	<form class="navbar-form pull-right horizontal-form" role="form" name="Login" method="post" action="homeAluno.html">
              ...
              <div class="panel-heading"><h4>Cadastro</h4></div>
	              <div class="panel-body">
	                <ul class="nav nav-tabs">
										<li><a href="../homes">Aluno</a></li>
										<li class="active"><?php echo $this->Html->link('Professor', 
